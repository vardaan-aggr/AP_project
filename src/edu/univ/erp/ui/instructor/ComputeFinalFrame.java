...
public class ComputeFinalFrame {
    public ComputeFinalFrame(String roll_no) {
        ...
        student_no.setBounds(50, 450, 100, 30);
        f.add(student_no);
        JTextField num = new JTextField(50);
        num.setBounds(150, 450, 250, 30);
        f.add(num);
        ...
        quizLabel.setBounds(50, 300, 100, 30);
        f.add(quizLabel);
        JTextField quizMarks = new JTextField();
        quizMarks.setBounds(150, 300, 250, 30);
        f.add(quizMarks);

        JLabel midsemLabel = new JLabel("course code : ");
        ...
        JLabel endsemLabel = new JLabel("course code : ");
        endsemLabel.setBounds(50, 200, 100, 30);
        f.add(endsemLabel);
        JTextField endsemField = new JTextField();
        endsemField.setBounds(150, 200, 250, 30);
        f.add(endsemField);

        JButton add = new JButton("Add +");
        add.setBounds(150, 150, 100, 30);
        f.add(add);
    ...
    private char computeGrade(String quizMarks, String midsemMarks, String endsemMarks) {
        ...
        // int endsem = 0;
        // try {
        //     quiz = Integer.parseInt(quizMarks);
        // } catch (NumberFormatException  e) {
        //         JOptionPane.showMessageDialog(f, "Logged out.");
        // }

        // try {
        //     midsem  = Integer.parseInt(midsemMarks);
        // } catch (NumberFormatException  e) {
        //         JOptionPane.showMessageDialog(f, "Logged out.");
        // }

        // try {
        //     endsem  = Integer.parseInt(endsemMarks);
        // } catch (NumberFormatException  e) {
        //         JOptionPane.showMessageDialog(f, "Logged out.");
        // }
